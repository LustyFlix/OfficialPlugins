...
class BottomFragment(private val plugin: AniwaveProviderPlugin) : BottomSheetDialogFragment() {
    override fun onCreateView(
        ...
        val outlineId =
                plugin.resources!!.getIdentifier("outline", "drawable", "com.medusa")

        // building save button and settings click listener
        val saveIconId =
                plugin.resources!!.getIdentifier("save_icon", "drawable", "com.medusa")
        ...
        val radioBtnId =
                plugin.resources!!.getIdentifier("radio_button", "layout", "com.medusa")
