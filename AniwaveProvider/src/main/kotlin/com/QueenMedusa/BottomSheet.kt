...
class BottomFragment(private val plugin: AniwaveProviderPlugin) : BottomSheetDialogFragment() {
    override fun onCreateView(
        ...
        val outlineId =
                plugin.resources!!.getIdentifier("outline", "drawable", "com.QueenMedusa")

        // building save button and settings click listener
        val saveIconId =
                plugin.resources!!.getIdentifier("save_icon", "drawable", "com.QueenMedusa")
        ...
        val radioBtnId =
                plugin.resources!!.getIdentifier("radio_button", "layout", "com.QueenMedusa")
